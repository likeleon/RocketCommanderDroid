...
namespace rcd
{
    ...
    @remarks
        ...
        SETUP:
            ...
            1) Instantiate the OgreSprites::Sprite object as usual with a standard new,
            and leave it in a place that your program will be able to access the pointer later.

                OgreSprites::Sprite* spriteHandler = new OgreSprites::Sprite();

            2) Give the Sprite a resource path, this *must* be done or you won't be able to load
    ...
    */
	...
	public:
        ...
        */
        void DrawSprite(const std::string& spriteName, float x, float y, const Ogre::ColourValue &color, float alpha, bool additiveBlend = false);
        ...
        @remarks
            ...
            @param
                alpha The alpha value to used when drawing. 0.0 is totally transparent, 1.0 is completely solid.
        */
        void DrawSprite(const std::string& spriteName, float x, float y, const Rect& spriteRect, const Ogre::ColourValue &color, float alpha, bool additiveBlend = false);
        ...
        @remarks
            ...
            @param
                alpha The alpha value to used when drawing. 0.0 is totally transparent, 1.0 is completely solid.
        */
		void DrawSprite(const std::string& spriteName, const Rect& destRect, const Rect& spriteRect, const Ogre::ColourValue &color, float alpha, bool additiveBlend = false);
